...
class Dataos_m2 extends CI_Model {

    var $table = 'tx_biodata_os';

    var $column_order = array(null, 'biodata_nik', 'biodata_nama', 'biodata_jenis_kelamin', 'biodata_tempat_lahir', 'biodata_pendidikan', 'biodata_status', 'biodata_create'); 
