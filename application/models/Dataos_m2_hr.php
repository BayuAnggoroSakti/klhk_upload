...
class Dataos_m2_hr extends CI_Model {

    var $table = 'tx_biodata_os';

    var $column_order = array(null, null,'biodata_nik', 'biodata_nama', 'biodata_jenis_kelamin', 'biodata_tempat_lahir', 'biodata_pendidikan', 'biodata_status', 'biodata_create'); 
    var $column_search = array('biodata_nik', 'biodata_nama', 'biodata_jenis_kelamin', 'biodata_tempat_lahir', 'biodata_pendidikan', 'biodata_status', 'biodata_create'); 
