			...
			<div class="tab-content">
				...
				<div class="panel panel-flat">
					...
					<div class="panel-heading">
						...
						<h6 class="panel-title"><b>TAMBAH POSISI BARU</b></h6>
					</div>
					
					<div class="panel-body">
						<form id="frm_tambah" action="<?php echo base_url('os/posisi/xsave');?>" method="post" enctype="multipart/form-data">
							<div class="form-group">
								<div class="row">
									<div class="col-md-6">
										<label>Nama posisi <span class="text-danger">*</span></label>
										<input type="text" style="font-size: 14px;" name="xposisi" id="xposisi" class="form-control  text-semibold required" autocomplete="off" minlength="5" maxlength="50" placeholder="min 5 character" value="<?=set_value('xposisi');?>" required>
										<div id="pesan"></div>
									</div>
									<div class="col-md-6">
										<label>Deskripsi </label>
										<input type="text" style="font-size: 14px;" name="xdeskripsi" id="xdeskripsi" class="form-control ">
