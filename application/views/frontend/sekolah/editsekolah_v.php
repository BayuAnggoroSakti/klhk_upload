...
<script src="<?php echo base_url(); ?>assets/js/sweetalert2.min.js"></script>
	...
	<script>
		<?php
		foreach ($dtuser as $u) {
			$vsekolahid 	  = trim($u->sekolah_id);
			$vsekolah 		  = trim($u->sekolah_nama);
		}		
	?>
	  var valid = false;
			...
			<div class="tab-content">
				...
				<div class="panel panel-flat">
					...
					<div class="panel-heading">
						...
						<h6 class="panel-title"><b>EDIT SEKOLAH</b></h6>
					</div>
					
					<div class="panel-body">
						<form id="frm_tambah" action="<?php echo base_url('os/sekolah/xupdate');?>" method="post" enctype="multipart/form-data">
							<input type="hidden" name="xid" value="<?=$vsekolahid;?>">
							<div class="form-group">
								<div class="row">
									<div class="col-md-6">
										<label>Nama Sekolah <span class="text-danger">*</span></label>
										<input type="text" style="font-size: 14px;" name="xsekolah" id="xsekolah" class="form-control  text-semibold required" autocomplete="off" minlength="5" maxlength="50" placeholder="min 5 character" value="<?=$vsekolah;?>" required>
										<div id="pesan"></div>
									</div>
