...
<script src="<?php echo base_url(); ?>assets/js/sweetalert2.min.js"></script>
		...
		function hapusData(xid) {
		    ...
		    swal({
		        ...
		        if (!isConfirm) return;
			        $.ajax({
			            url : "<?=site_url('os/dataos/xdelete')?>/"+id,
			            type: "POST",
			            dataType: "JSON",
						...
						<div class="panel panel-flat">
							<div class="panel-heading">
								...
								<div class="heading-elements">
									<a href="<?php echo base_url('os/dataos/xadd');?>"><button type="button" class="btn btn-primary btn-xs btn-icon" title="Add User"><i class="icon-user-plus"></i>&nbsp; Tambah OS</button></a>
	                			</div>
											...
											<tr>
												...
												<td>
													<?php
											         ...
											         $uid2 = "'".$uid."'"; 
											         $link1  = site_url('os/dataos/xedit/'.base64_encode($uid));
													  if ($data_r->biodata_status==0) {
												           echo '<a href="'.$link1.'" title="Edit Data" class="text-center text-success"><i class="icon-pencil7"></i></a>';
													         echo '<a onclick="hapusData('.$uid2.')" title="Delete Data"><i class="icon-cancel-square text-danger"></i></a>';
												         } elseif (($data_r->biodata_status==1)) {  
												            echo '<a href="'.$link1.'" title="Edit Data" class="text-center text-success"><i class="icon-pencil7"></i></a>';
												         }
...
$(document).ready(function() {
    ...
    table = $('#tableData').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('os/dataos/ajax_dataos')?>",
            "type": "POST"
        },
