...
<script src="<?php echo base_url(); ?>assets/js/sweetalert2.min.js"></script>
		...
		function hapusData(xid) {
		    ...
		    swal({
		        ...
		        if (!isConfirm) return;
			        $.ajax({
			            url : "<?=site_url('os/data_transfer/xdelete')?>/"+id,
			            type: "POST",
			            dataType: "JSON",
						...
						<div class="panel panel-flat">
							<div class="panel-heading">
								...
								<div class="heading-elements">
										<a href="#"  data-toggle="modal" data-target="#addModal"><button type="button" class="btn btn-warning btn-xs btn-icon" title="Add Test"><i class="icon-user-plus"></i>&nbsp; Transfer Kandidat</button></a>
	                			</div>
									...
									$i=1;
										foreach ($data_transaksi as $data_r) { ?>
											<tr>
												...
												<td>
													<a href="<?php echo site_url('os/dataos/xedit/'.base64_encode($data_r->biodata_id)) ?>" title="Detail Data" class="text-center text-success"><i class="icon-pencil7"></i></a>

													<a onclick="hapusData('<?php echo $data_r->biodata_id ?>')" title="Delete Data"><i class="icon-cancel-square text-danger"></i></a>
												</td>
											</tr>
									<?php
										}
