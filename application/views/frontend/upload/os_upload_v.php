...
<script src="<?php echo base_url(); ?>assets/js/sweetalert2.min.js"></script>
		...
		function hapusData(xid) {
		    ...
		    swal({
		        ...
		        if (!isConfirm) return;
			        $.ajax({
			            url : "<?=site_url('os/upload/xdelete')?>/"+id,
			            type: "POST",
			            dataType: "JSON",
						...
						<div class="panel panel-flat">
							<div class="panel-heading">
								...
								<div class="heading-elements">
									...
									<a class="btn btn-primary btn-labeled btn-xs" title="Tambah Data Upload" href="<?php echo site_url('os/upload/xadd'); ?>"><b><i class="icon-add"></i></b>Add Upload</a>
	                			</div>
...
$(document).ready(function() {
    ...
    table = $('#tableData').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('os/upload/ajax_upload')?>",
            "type": "POST"
        },
