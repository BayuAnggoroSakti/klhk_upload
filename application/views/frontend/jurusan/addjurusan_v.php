			...
			<div class="tab-content">
				...
				<div class="panel panel-flat">
					...
					<div class="panel-heading">
						...
						<h6 class="panel-title"><b>TAMBAH JURUSAN BARU</b></h6>
					</div>
					
					<div class="panel-body">
						<form id="frm_tambah" action="<?php echo base_url('os/jurusan/xsave');?>" method="post" enctype="multipart/form-data">
							<div class="form-group">
								<div class="row">
									<div class="col-md-6">
										<label>Nama Jurusan <span class="text-danger">*</span></label>
										<input type="text" style="font-size: 14px;" name="xjurusan" id="xjurusan" class="form-control  text-semibold required" autocomplete="off" minlength="5" maxlength="50" placeholder="min 5 character" value="<?=set_value('xjurusan');?>" required>
										<div id="pesan"></div>
									</div>
