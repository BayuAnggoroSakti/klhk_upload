...
$(function() {
    ...
    $('[name="format-nik"]').formatter({
        pattern: '{{9999999999999999}}'
    });

    $('[name="format-kode"]').formatter({
        pattern: '{{999999}}'
    });
    ...
    $('[name="format-international-phone"]').formatter({
        pattern: '+62 {{999}} {{999}} {{999}}'
    });

    $('[name="format-handphone"]').formatter({
        pattern: '+62 {{999999999999999}}'
    });

    $('[name="t_hp1"]').formatter({
        pattern: '+62 {{999999999999999}}'
    });

    $('[name="t_hp2"]').formatter({
        pattern: '+62 {{999999999999999}}'
    });
